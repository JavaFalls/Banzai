...
const W_PRI_STATS = [
	...
	{"id": W_PRI_SWORD             , "implemented": true , "name": "Sword"             , "description": "The hack-n-slash of the ages. Get personal with this blade"                                             , "info": "Stab, stab, stab"                                  , "attack":    10, "speed":  0.01, "type": "Melee" , "icon": preload("res://assets/weapons/sword.png")             , "sprite": preload("res://assets/weapons/sword.png")              , "scene": preload("res://scenes/weapons/melee.tscn")              , "swing_scene": preload("res://scenes/weapons/melee_animations/sword.tscn"), "scale" : 1.5},

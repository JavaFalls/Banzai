...
const W_SEC_STATS = [
	...
	{"id": W_SEC_NUKE              , "implemented": true , "name": "Nuke"              , "description": "Really big boom"                                                                                        , "info": "Explosion radius is roughly 1/4th of the arena"    , "attack": 10000, "speed": 15.0 , "type": "Tech"  , "icon": preload("res://assets/weapons/icon_nuke.png")  , "sprite": preload("res://assets/weapons/nuke.png")         , "scene": preload("res://scenes/weapons/tech/nuke.tscn")},

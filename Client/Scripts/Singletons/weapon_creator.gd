...
const W_PRI_STATS = [
	...
	{"id": W_PRI_RUBBER_BOW        , "implemented": true , "name": "Rubber Bow"        , "description": "Launches projectiles which can bounce off walls up to 4 times. Each bounce reduces the projectiles damage by 1.", "info": "Projectiles bounce off walls 4 times. Each bounce drops damage by 1.", "attack":     4, "speed":  0.2 , "type": "Ranged", "icon": preload("res://assets/weapons/bow_regular.png")       , "sprite": preload("res://assets/weapons/rubber_arrow.png")       , "scene": preload("res://scenes/weapons/projectile_launcher.tscn"), "projectile_speed": 250, "projectile_scene": preload("res://Scenes/weapons/projectile.tscn")},
	{"id": W_PRI_ZORROS_GLARE      , "implemented": false, "name": "Zorro's Glare"     , "description": "If looks could kill, this would kill you. Oh wait, it can kill you."                                            , "info": "Death Laser."                                                        , "attack":    15, "speed":  2.0 , "type": "Ranged", "icon": preload("res://assets/weapons/icon_zorros_glare.png") , "sprite": preload("res://assets/weapons/laser_beam_of_death.png"), "scene": preload("res://scenes/weapons/zorros_glare.tscn")       , "projectile_speed": 500, "projectile_scene": preload("res://Scenes/weapons/zorros_glare_projectile.tscn")}
]
const W_SEC_STATS = [
	{"id": W_SEC_MINE              , "implemented": true , "name": "Mine"              , "description": "A trap set on the ground, explodes when triggered."                                                     , "info": "Explosion radius is roughly 2 times bot size."                  , "attack":    30, "speed":  1.0 , "type": "Trap"  , "icon": preload("res://assets/weapons/mine.png")           , "sprite": preload("res://assets/weapons/mine.png")           , "scene": preload("res://scenes/weapons/trap.tscn"), "lifetime": 5.0, "trap_scene": preload("res://scenes/weapons/traps/mine.tscn")},

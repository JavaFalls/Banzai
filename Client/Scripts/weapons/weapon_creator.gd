...
# This is an dictionary array of all of the stats of the weapons.
# All cooldowns are given in seconds (speed = cooldown)
...
const W_PRI_STATS = [
	{"id": W_PRI_ACID_BOW          , "implemented": false, "name": "Acid Bow"          , "description": "Leaves a residue on contact, which causes latent damage for 2.5 seconds"                                , "info": "Deals an extra 5 damage over 2.5 seconds"          , "attack":   1, "speed":  0.1, "type": "Ranged", "icon": preload("res://assets/weapons/arrow_regular.png"), "sprite": preload("res://assets/weapons/arrow_regular.png"), "scene": preload("res://scenes/weapons/primary/acid_bow.tscn")          , "projectile_speed": 5},
	{"id": W_PRI_EXPLODING_SHURIKEN, "implemented": false, "name": "Exploding Shuriken", "description": "Thrown projectile which detonates on contact with opponent or barrier"                                  , "info": "Explosion radius is roughly 2 times bot size"      , "attack":   5, "speed":  0.2, "type": "Ranged", "icon": preload("res://assets/weapons/arrow_regular.png"), "sprite": preload("res://assets/weapons/arrow_regular.png"), "scene": preload("res://scenes/weapons/primary/exploding_shuriken.tscn"), "projectile_speed": 5},
	{"id": W_PRI_PRECISION_BOW     , "implemented": false, "name": "Precision Bow"     , "description": "Launches a single projectile which causes severe damage on contact"                                     , "info": "Very accurate"                                     , "attack":  15, "speed":  0.5, "type": "Ranged", "icon": preload("res://assets/weapons/arrow_regular.png"), "sprite": preload("res://assets/weapons/arrow_regular.png"), "scene": preload("res://scenes/weapons/primary/precision_bow.tscn")     , "projectile_speed": 5},
	{"id": W_PRI_SCATTER_BOW       , "implemented": false, "name": "Scatter Bow"       , "description": "Launches 3 projectiles which cause damage if contact is made with an opponent"                          , "info": "Projectile direction is random in a 90 degree cone", "attack":   2, "speed":  0.1, "type": "Ranged", "icon": preload("res://assets/weapons/arrow_regular.png"), "sprite": preload("res://assets/weapons/arrow_regular.png"), "scene": preload("res://scenes/weapons/primary/scatter_bow.tscn")       , "projectile_speed": 5},
	...
	{"id": W_PRI_RUBBER_BOW        , "implemented": false, "name": "Rubber Bow"        , "description": "Launches projectiles which bounce off walls for a 2.5 seconds, or until contact is made with a bot"     , "info": "Projectiles bounce off walls for 2.5 seconds"      , "attack":   2, "speed":  0.1, "type": "Ranged", "icon": preload("res://assets/weapons/arrow_regular.png"), "sprite": preload("res://assets/weapons/arrow_regular.png"), "scene": preload("res://scenes/weapons/primary/rubber_bow.tscn")        , "projectile_speed": 5},
	{"id": W_PRI_ZORROS_GLARE      , "implemented": false, "name": "Zorro's Glare"     , "description": "If looks could kill, this would kill you. Oh wait, it can kill you."                                    , "info": "Death Laser"                                       , "attack":  50, "speed":  0.0, "type": "Ranged", "icon": preload("res://assets/weapons/arrow_regular.png"), "sprite": preload("res://assets/weapons/arrow_regular.png"), "scene": preload("res://scenes/weapons/primary/zorros_glare.tscn")      , "projectile_speed": 5}
]
const W_SEC_STATS = [
	{"id": W_SEC_MINE              , "implemented": false, "name": "Mine"              , "description": "A trap set on the ground, explodes when triggered"                                                      , "info": "Explosion radius is roughly 2 times bot size"      , "attack":  10, "speed":  1.0, "type": "Trap"  , "icon": preload("res://assets/weapons/arrow_regular.png"), "sprite": preload("res://assets/weapons/arrow_regular.png"), "scene": preload("res://scenes/weapons/secondary/mine.tscn")},
	{"id": W_SEC_NUKE              , "implemented": false, "name": "Nuke"              , "description": "Really big boom"                                                                                        , "info": "Explosion radius is roughly 1/4th of the arena"    , "attack": 200, "speed": 15.0, "type": "Tech"  , "icon": preload("res://assets/weapons/arrow_regular.png"), "sprite": preload("res://assets/weapons/arrow_regular.png"), "scene": preload("res://scenes/weapons/secondary/nuke.tscn")},
...
# The following 3 functions return a dictionary arrays containing only the weapons that have been implemented in game
